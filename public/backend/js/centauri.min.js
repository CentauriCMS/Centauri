...
Centauri.Components.DropdownsComponent = () => {
	...
	if( $('.fancy-dropdown').length > 0 ) {
		$('.fancy-dropdown').each(function(){
			//create a morphDropdown object for each .fancy-dropdown
...
Centauri.Components.PagesComponent = (module) => {
    ...
    Centauri.Components.PagesComponent.pages.newCEButton = "<button class='btn btn-default m-0 py-2 px-2 waves-effect waves-light' data-action='newContentElement'><i class='fas fa-plus'></i> " + Centauri__trans.modals.btn_content + "</button>";
};
...
Centauri.fn.__ImageSelectFileButton = () => {
    $("div[data-trigger='selectfile'], button[data-trigger='selectfile']").each(() => {
        $(this).on("click", this, () => {
...
Centauri.Events.EditorComponent.Input = {};
